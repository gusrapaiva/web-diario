    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-md p-10 mt-10">
        ...
        @csrf  
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input type="text" name="data" id="data" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " readonly value="{{date('d-m-Y')}}" />
            ...
            <!-- titulo -->
            <div class="relative z-0 w-full mb-5 group">
                <input type="text" autocomplete="off" name="titulo" id="titulo" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
            ...
            <!-- texto -->
            <div class="relative z-0 w-full mb-5 group">
                <textarea type="text" rows="10" name="texto" id="texto" class="resize-none block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peerbg-blue-50" placeholder=" " required > </textarea>
                <label for="texto" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Seu texto</label>
            </div>
            <!-- imagem -->
            <div class="mb-4">
